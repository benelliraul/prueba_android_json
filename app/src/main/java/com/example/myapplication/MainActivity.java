...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //String id_rec=sharedPref.getString("id_tienda", "no hay");
        SharedPreferences sharedPref = getSharedPreferences("teinda_logueada",this.MODE_PRIVATE);
        String nombre_rec = sharedPref.getString("nombre","no hay");
        ...
        //Toast.makeText(this,"desde shared2"+celular_rec,Toast.LENGTH_LONG).show();
        //Toast.makeText(this,"el nombre"+nombre_rec,Toast.LENGTH_LONG).show();
        SharedPreferences.Editor editor = sharedPref.edit();
        ...
        if (id_tienda == "crear" || id_tienda == "null"){
            ...
            String nombre_recu=sharedPref.getString("nombre","null");
            nombre.setText(nombre_recu);
    ...
    private void cerrar_sesion() {
        SharedPreferences archivo = getSharedPreferences("teinda_logueada",getApplicationContext().MODE_PRIVATE);
        ...
        editor.putString("id_tienda","cerro la sesion");
        editor.apply();
    }
